                  ...
                  <tbody>
                    {squadRows.map((squad) => (
                      <tr key={squad.id}>
                              ...
                              <small>
                                {squad.owner?.name
                                  ? (
                                    <>
                                      proprietário:{' '}
                                      <Link to={buildProfilePath(squad.owner)} className={styles.inlineProfileLink}>
                                        {squad.owner.name}
                                      </Link>
                                    </>
                                  )
                        ...
                        <td>
                          <div className={styles.rowActions}>
                            <Link to={buildSquadPath(squad)} className={styles.dashboardLink}>Abrir dashboard</Link>
                            {canManageSquads ? (
                              <>
                      ...
                      <tr key={entry.id}>
                        <td>
                          <div className={styles.primaryCell}>
                            ...
                            <div>
                              <strong>
                                <Link to={buildProfilePath(entry)} className={styles.inlineProfileLink}>
                                  {entry.name}
                                </Link>
                              </strong>
                      ...
                      <tr key={entry.name}>
                        ...
                        <td>
                          {canManageGdvs ? (
                            ...
                            <Link to={buildProfilePath(entry.owner)} className={styles.inlineProfileLink}>
                              {entry.owner.name}
                            </Link>
                          ) : (
